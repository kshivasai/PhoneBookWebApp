...
namespace PhoneBookWebApp.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,FirstName,LastName,PhoneNumber,Email,IsActive")] People people)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FirstName,LastName,PhoneNumber,Email,IsActive")] People people)
        {
            if (ModelState.IsValid)
            {
